...
import { AudioTranscription, AudioTranscriptionOptions, AudioTranslation, AudioTranslationOptions, ChatCompletions, ChatCompletionsOptions, ChatRequestMessage, Completions, CompletionsOptions, Embeddings, EmbeddingsOptions, ImageGenerations } from "../../../models/models.js";
...
export declare function listCompletions(context: Client, deploymentName: string, prompt: string[], options?: GetCompletionsOptions): AsyncIterable<Omit<Completions, "usage">>;
...
export declare function listChatCompletions(context: Client, deploymentName: string, messages: ChatRequestMessage[], options?: GetChatCompletionsOptions): AsyncIterable<ChatCompletions>;
/**
